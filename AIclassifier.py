...
corpus_with_unk = [word[0] for word in word_freq.items() if int(word[1]) > 3] # < 2 or <= 2
...
# Configurations
adaclassifier = AdaBoostClassifier(n_estimators=50, learning_rate=1.2) # n_est 25, 50, 75, 100,200, 300 lr 0.5, 1
